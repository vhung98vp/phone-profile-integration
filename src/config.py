...
ES_PROPERTY = {
    ...
    'total_weekend_call': os.environ.get('ES_PROPERTY_TOTAL_WEEKEND_CALLS', 'total_weekend_call'),
    'total_night_call': os.environ.get('ES_PROPERTY_TOTAL_NIGHT_CALLS', 'total_night_call'),
